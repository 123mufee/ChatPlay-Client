      ...
      {loading ? (
        ...
        <>
          <main className="profile-page">
            ...
            {/* <section className="relative py-16 bg-white"> */}
              <div className="container mx-auto px-4">
                <div className="relative flex flex-col min-w-0 break-words bg-purple-300 w-full mb-6 shadow-xl rounded-lg -mt-64">
                  <div className="px-6">
                    <form onSubmit={saveEdit}>
                      <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-purple-300 border-0">
                        <div className="rounded-t bg-purple-300 mb-0 px-6 py-6">
                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                          {/* <form onSubmit={saveEdit}> */}
                          <h6 className="text-purple-900 text-sm mt-3 mb-6 font-bold uppercase">
                            User Information
                          </h6>
