          ...
          <div className="container mx-auto px-4 h-full">
            <div className="flex content-center items-center justify-center h-full">
              <div className="w-full lg:w-4/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0 opacity-90">
                  ...
                  <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form onSubmit={sentOtp}>
                      <div className="relative w-full mb-3">
                        <label
                          className="block uppercase text-purple-600 text-xs font-bold mb-2"
                        ...
                        <input
                          type="email"
                          className="border-0 px-3 py-3 placeholder-black text-black bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                          placeholder="Email"
                      ...
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          type="text"
                          className="border-0 px-3 py-3 placeholder-black text-black rounded text-sm shadow focus:outline-none focus:ring w-full"
                      ...
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          type="date"
                          className="border-0 px-3 py-3 placeholder-purple-900 text-black rounded text-sm shadow focus:outline-none focus:ring w-full"
                          placeholder=""
                          style={{ transition: "all .15s ease" }}
                          required
                      ...
                      <div className="relative w-full mb-3">
                        ...
                        <input
                          type="password"
                          className="border-0 px-3 py-3 placeholder-black text-purple-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                      ...
                      <div className="text-center mt-6">
                        <button
                          className="bg-purple-800 text-white active:bg-blue-900 hover:bg-blue-400 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full"
                          type="submit"
                          style={{ transition: "all .15s ease" }}
                        >
                          Continue
